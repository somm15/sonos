...
// Living room
IPAddress g_JoeyIP(192, 168, 1, 204);
...
void handleRoot() {
  ...
  msg += "<script>var intervalID = window.setInterval(getVolume, 5000);$('#console').submit(function(){parseCmd($(\"#console_text\").val());return false;});</script>";
  msg += "</div>\n";
  msg == "</body>\n";
  msg += "</html>\n";
